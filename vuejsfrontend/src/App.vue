                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0 align-items-center">
                                    <img src="../src/assets/img/Cars/Focus/Icon.png" alt="Focus" width="90%"
                                        height="90%"><a href="/Cars" class="dropdown-item">Focus Titanium</a>
                                    <img src="../src/assets/img/Cars/Mustang/Icon.png" alt="Mustang" width="90%"
                                        height="90%"><a href="/Cars" class="dropdown-item">Mustang GT</a>
                                    <img src="../src/assets/img/Cars/Ranger Raptop/Icon.png" alt="Ranger Raptor"
                                        width="90%" height="90%"><a href="/Cars" class="dropdown-item">Ranger Raptor</a>
                                    <img src="../src/assets/img/Cars/S-Max/Icon.png" alt="S-Max" width="90%"
                                        height="90%"><a href="/Cars" class="dropdown-item">S-Max</a>
                                    <img src="../src/assets/img/Cars/Mustang Mach-E/Icon.png" alt="Mustang Mach-E"
                                        width="90%" height="90%"><a href="/Cars" class="dropdown-item">Mustang
                                        Mach-E</a>
