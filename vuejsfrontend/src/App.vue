                        ...
                        <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                    ...
                                    <div class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu rounded-0 m-0">
                                            ...
                                            <router-link class="dropdown-item"
                                                to="/login">Bejelenkezés</router-link>
                                ...
                                <router-link to="/login"
                                    class="btn btn-primary py-md-3 px-md-5 d-none d-lg-block" v-if="isLoggedIn == false" >Bejelenkezés</router-link>


                                    <button class="btn btn-danger py-md-3 px-md-5 d-none d-lg-block" @click="logout" v-if="isLoggedIn">Logout</button>
                    ...
                    <div class="col-lg-12 col-md-12 pt-3 mb-0">
                        ...
                        <table class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex mb-1 ">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                            class="bi bi-house m-1" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                            class="bi bi-envelope m-1" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <div class="d-flex mb-1 ">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                            class="bi bi-telephone m-1" viewBox="0 0 16 16">
                                            <path
                                ...
                                <td>
                                    <a href="https://hu-hu.facebook.com/fordmagyarorszag/" class=" fa fa-facebook m-1 "></a>
