<template>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img style="width:100%; height: 300px;" src="../assets/img/Header/bodyGif.gif" alt="FordHeaderGif">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 300px;">
                            <h1 class="display-4 text-white text-uppercase mb-md-4">Ford motor company</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12" >
                <div class="mb-4">
                    <h1 class="display-4 text-uppercase mb-0">Üdv a Ford Motor Company oldalán</h1>
                </div>
                ...
                <p class="mb-4">Feltűnő új dizájnjával és új generációs intelligens megoldásaival a Ford Focus
                    minden korábbinál jobb vezetési élményt kínál.</p>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a href="/cars"><img src="../assets/img/Ad/1.jpeg" class="d-block w-100" alt="1ad"
                                    style="width:100%; height: auto; max-height: 520px;" herf=""></a>
    ...
    <div class="container-fluid p-3 col-12">
        <div class="mb-3 text-center">
            <h1 class="display-4 text-uppercase mb-0">Ajánlatok</h1>
        </div>
        <div class="row gx-3 gy-4">
            <div class="col-12">
                <div class="team-item position-relative">
                    ...
                    <div class="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-3"
