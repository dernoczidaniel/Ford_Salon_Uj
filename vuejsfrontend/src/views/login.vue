  ...
  <body class="LoginRegistrationbackground BodySize ">
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-10 col-sm-12">
        ...
        <div class="LoginRegistrationbackgroundMenu mt-5">
          <div class="m-4 p-4">
            ...
            <form @submit.prevent="login">
              ...
              <div class="input-group mb-3">
                ...
                <input type="email" class="form-control inputTransparent text-light" id="email" placeholder="E-mail cím"
              ...
              <div class="input-group mb-3">
                ...
                <input type="password" class="form-control inputTransparent text-light" id="password" placeholder="Jelszó"
